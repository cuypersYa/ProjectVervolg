...
<asp:Content ID="Content2" ContentPlaceHolderId="ContentHeadCenter" runat="server">
    ...
    <h2><asp:Label ID="lblTitel" runat="server" AssociatedControlID="txtTitel" Text="Titel"></asp:Label></h2>
        ...
        <asp:RequiredFieldValidator ID="rfvTitel" runat="server" ControlToValidate="txtTitel" ErrorMessage="Gelieve dit in te vullen" ValidationGroup="MaakAan"></asp:RequiredFieldValidator>
      ...
      <h2><asp:Label ID="lblInformatie" runat="server" AssociatedControlID="txtInformatie" Text="Informatie"></asp:Label></h2>
        ...
        <asp:RequiredFieldValidator ID="rfvInformatie" runat="server" ControlToValidate="txtInformatie" ErrorMessage="Gelieve dit in te vullen" ValidationGroup="MaakAan"></asp:RequiredFieldValidator>
        <br />
