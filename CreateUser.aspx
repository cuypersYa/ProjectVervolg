...
<asp:Content ID="Content2" ContentPlaceHolderId="ContentHeadCenter" runat="server">
    ...
    <tr>
        ...
        <td><asp:RequiredFieldValidator ID="rqvLeeg1" runat="server" ControlToValidate="txtNaam" ErrorMessage="Mag niet leeg blijven" ValidationGroup="create"></asp:RequiredFieldValidator></td>
     </tr>
     <tr>
        ...
        <td><asp:RequiredFieldValidator ID="rqvLeeg2" runat="server" ControlToValidate="txtVoornaam" ErrorMessage="Mag niet leeg blijven" ValidationGroup="create"></asp:RequiredFieldValidator></td>
      </tr>  
        <tr>
            ...
            <td><asp:RegularExpressionValidator ID="revEmail" runat="server" ControlToValidate="txtEmail" ErrorMessage="Geen geldig e-mailadres" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*" ValidationGroup="create"></asp:RegularExpressionValidator></td>
        </tr>
      <tr>
        ...
        <td><asp:RequiredFieldValidator ID="rfvLeeg3" runat="server" ControlToValidate="txtGebruikersnaam" ErrorMessage="Mag niet leeg blijven" ValidationGroup="create"></asp:RequiredFieldValidator></td>
      </tr>
      <tr>
        ...
        <td><asp:RequiredFieldValidator ID="rfvLeeg4" runat="server" ControlToValidate="txtWachtwoord" ErrorMessage="Mag niet leeg blijven" ValidationGroup="create"></asp:RequiredFieldValidator></td>
      </tr>
      <tr>
        ...
        <td><asp:CompareValidator ID="cvWachtwoord" runat="server" ControlToCompare="txtWachtwoord" ControlToValidate="txtWachtwoord2" ErrorMessage="Wachtwoord komt niet overeen" ValidationGroup="create"></asp:CompareValidator></td>
       </tr>
    </table>
